    ...
    return ReactDOM.createPortal(
        <>
            ...
            <div className={`fixed flex w-[20rem] h-[15rem] flex-col rounded-lg text-center
                    items-center justify-around gap-3 px-10 py-8 shadow-2xl top-[50%] 
                    left-[50%] -translate-x-[50%] -translate-y-[50%] shadow-richblack-900 
                    bg-richblack-800 border-[1px] border-richblack-400`}>
