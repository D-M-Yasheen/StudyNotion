...
export const Template = ({
  ...
  return (
    <div
      className="w-full flex mt-2 mx-auto lg:flex-row flex-col-reverse
    ...
    >
      ...
      <div className="lg:w-1/3 md:w-9/12 sm:w-10/12 mx-auto w-full p-8 flex flex-col">
        <div className="space-y-9">
          ...
          <div className="space-y-3">
            ...
            <p
              className="text-richblack-100 text-lg
                                    font-normal"
            >
              {description}
              <span
                className=" text-blue-100 font-edu-sa 
      ...
      <div className="lg:w-1/3 md:w-9/12 sm:w-10/12 w-11/12 mx-auto p-8 select-none">
        <div className="relative">
          ...
          <img width={558} height={504} src={img} className="relative " />
        </div>
      </div>
    </div>
  );
