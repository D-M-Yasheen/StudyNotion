...
export const SignupForm = () => {
  ...
  const Condition = () => {
    return (
      <div
        className="absolute group-hover:visible invisible 
        ...
        <div className="flex lg:flex-row flex-col gap-5">
          ...
          <label className="w-full">
            <p className="text-sm font-normal text-richblack-5">
              First name
              <sup className="mx-1 text-pink-200 text-xs">*</sup>
            </p>
        ...
        <div className="flex lg:flex-row flex-col gap-5">
          ...
          <label className="w-full flex flex-col gap-1">
            <div className="flex">
              ...
              <div
                className="relative text-richblack-300 group 
                            cursor-pointer"
              >
            ...
            <div className="w-full flex flex-col relative ">
              ...
              <div
                className={`text-richblack-300 absolute 
              ...
              {/* <div
                className="text-richblack-300 absolute right-3 
          ...
          <label className="w-full flex flex-col gap-1">
            ...
            <div className="flex flex-col relative ">
              <input
                ...
                className="w-full text-richblack-5 text-base p-3 border-b-[1px] border-richblack-400
                bg-richblack-700 rounded-lg"
