...
export const CodeBlocks = ({
    ...
    mt-6 items-center lg:gap-x-16 gap-y-16 justify-between`}>
            ...
            flex-col items-start text-start gap-8">
                <div className=''>
                    {heading}
                </div>
            ...
            bg-gradient-to-r from-richblack-800
            text-sm bg-opacity-25
            lg:w-[500px] h-fit rounded-md 
            border-t-[1px] border-l-[1px]
            border-richblack-400
            border-opacity-25 blur-custom'>
