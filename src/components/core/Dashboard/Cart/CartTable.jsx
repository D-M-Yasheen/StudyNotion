...
export const CartTable = ({ course }) => {
    ...
    return (
        <section className='w-full flex flex-wrap gap-5 flex-row justify-between'>
            ...
            <div className='flex flex-wrap gap-6 lg:flex-row flex-col '>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex flex-wrap items-center gap-2 text-yellow-100 font-semibold text-base'>
                        {/* TODO */}
                        <p>{avgRatingCount}</p>
