    ...
    useEffect(() => {
        const fetchCourseFullDetails = async () => {
            ...
            if (result) {
                ...
                // setInstructions(JSON.parse(courseDetails?.instructions))
                // console.log("course details we got =============>: ", courseDetails?.courseContent)
                // console.log("user details we got : ", user)
            ...
            flex-col items-start gap-6 py-16'>
                ...
                border-richblack-500 py-8 gap-6'>
                                ...
                                <div className='flex flex-col gap-3'>
                                    ...
                                    <button
                                        onClick={courseDetails?.studentsEnrolled.includes(user?._id) ?
